...
<link rel='canonical' href='http://www.dadaedu.icoc.me/mdetail.jsp?id=101'>
...
<link type='text/css' href=http://2.ss.faisys.com/css/mDetail.min.css?v=201607111726 rel='stylesheet' />
...
#module26 .contentLineIcon {*padding:0;}
#module26 .contentLineIcon {*width:0;}
...
<div id="memberBarArea" class="memberBarArea g_editPanel">
	...
	<div id="memberBar" class="memberBar">
		...
		<div class="m_left">			
			<a class='memberHeadPicOuter' href='mCenter.jsp'><img id='topBarMemberPic'class='msgBoard_member_headpic' src='http://0.ss.faisys.com/image/tx1.png' style=
		...
		"height:30px"
			...
			<span class="user_level_icon" style='position:relative;margin-top: 12px;'></span>
			<a href='mainweb.html' class="exit">[退出]</a>
		</div> 
...
<div class='searchBox searchBoxStyle69'><div class='searchBoxContainer' style=''><input class='productSearch g_itext' style='width:185px;'  placeholder='' size='10' value='' /><a class='g_btn searchBoxBtn' href='newpr.html' onclick='Site.searchProduct(314);return true;'><span>搜索</span></a></div>
</div>
<div class='recommandKeyBox'><div class='linkKeys'><a class='recommandKey' href='newpr.html' onclick='Site.searchProductByKey(314,"");return true;'><span></span></a></div></div>
</div>
</td>
...
<td class='itemCenter'><a hidefocus='true' style='outline:none;' href='newmainweb.html' target='_self' onclick='return true;'><span class='itemName0'>首页</span></a></td>
...
<tr>
<td class='itemLeft'></td>
<td class='itemCenter'><a hidefocus='true' style='outline:none;' href='newshopping.html' target='_self' onclick='return true;'><span class='itemName0'>购物车</span></a></td>
<td class='itemRight'></td>
</tr>
</table>
...
<tr>
<td class='itemLeft'></td>
<td class='itemCenter'><a hidefocus='true' style='outline:none;' href='newmessagebox.html' target='_self' onclick='return true;'><span class='itemName0'>留言</span></a></td>
<td class='itemRight'></td>
</tr>
</table>
</div>
...
<div class='titleText titleText404'><span class='fk_mainTitle mainTitle404'>订单详情</span></div>
</td>
...
<table foldId='34' class='g_foldContainerValue fold_J g_item' cellpadding='0' cellspacing='0'>
<form action="<c:url value='/payServlet'/>"> 
		商品订单号：<input type="text" value='20160714101' readonly name="p2_Order"><br/> 
	             支             付           金            额：<input type="text" value='0.1' readonly name="p3_Amt"><br/> 
		选择银行：<br/> 
